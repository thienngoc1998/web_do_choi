                                    ...
                                    @foreach($products as $key => $product)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{  route('admin.product.import', $product->id) }}" import-id="{{$product->id}}" product-name="{{ $product->pro_name }}" class="btn btn-xs btn-primary js-import-confirm"><i class="fa fa-trash"></i> Nhập hàng</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
