...
{{--                            </li>--}}
        ...
        <script type="text/javascript">
            ...
            $(function(){
                ...
                $(".js-import-confirm").click(function(event){
                    event.preventDefault();
                    let URL = $(this).attr('href');
                    let ID = $(this).attr('import-id');
                    ...
                    $.confirm( {
                        ...
                        content: '' +
                            ...
                            '<input type="number" placeholder="Số lượng" class="import-number form-control" required />' +
                            '</div>' +
                            '</form>',
                        buttons: {
                            formSubmit: {
                                ...
                                btnClass: 'btn-blue',
                                action: function () {
                                    var numberImport = this.$content.find('.import-number').val();
                                    if (!numberImport) {
