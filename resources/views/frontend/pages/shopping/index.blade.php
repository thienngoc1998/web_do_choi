            ...
            <div class="list">
                ...
                <div class="list__content">
                    ...
                    <div style="float: right;margin-top: 20px;">
                        <p  class="total_cart">Giảm giá : <b id="sub-discount">0%</b></p>
                        <br>
                        <p class="total_cart">Tổng tiền : <b id="sub-total">{{ \Cart::subtotal(0) }} đ</b></p>
                    </div>
                ...
                <div class="customer__content">
                    <form class="from_cart_register" action="{{ route('post.shopping.pay') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <input type="text" value="" name="discount" class="form-control discount_code" placeholder="Mã giảm giá" style="width: 60%; float: left;">
                                </div>
                                <div class="col-md-4">
            ...
            $('.btn-cart-discount').click(function () {
                ...
                $.ajax({
                   ...
                   if (results.type === 'success') {
                       $('#sub-total').text(results.totalMoney + ' đ');
                       $("#sub-discount").text(results.percentage+ " %");
