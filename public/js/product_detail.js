...
/***/ "./resources/js/common/lazyload_file.js":
/*!**********************************************!*\
  !*** ./resources/js/common/lazyload_file.js ***!
  \**********************************************/
...
/***/ "./resources/js/common/run_common.js":
/*!*******************************************!*\
  !*** ./resources/js/common/run_common.js ***!
  \*******************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _components_open_sidebar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../components/open_sidebar */ "./resources/js/components/open_sidebar.js");
/* harmony import */ var _components_open_sidebar__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_components_open_sidebar__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _library_lazyload_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../library/lazyload.min.js */ "./resources/js/library/lazyload.min.js");
/* harmony import */ var _library_lazyload_min_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_library_lazyload_min_js__WEBPACK_IMPORTED_MODULE_1__);
...
var RunCommon = {
  ...
  runMessages: function runMessages() {
    if (typeof TYPE_MESSAGE != "undefined") {
      switch (TYPE_MESSAGE) {
        case 'success':
          toastr__WEBPACK_IMPORTED_MODULE_2___default.a.success(MESSAGE);
          break;

        case 'error':
          toastr__WEBPACK_IMPORTED_MODULE_2___default.a.error(MESSAGE);
          break;
      }
    }
  },
  lazyLoadImage: function lazyLoadImage() {
    (function () {
      ...
      var ll = new _library_lazyload_min_js__WEBPACK_IMPORTED_MODULE_1___default.a({
        ...
        callback_error: function callback_error(element) {
          logElementEvent("ERROR", element); // element.src = "";
        }
      });
      $(".card-img-top").show();
    })();
  },
  messagesLogin: function messagesLogin() {
    $(".js-show-login").click(function (event) {
      event.preventDefault();
      toastr__WEBPACK_IMPORTED_MODULE_2___default.a.warning("Bạn phải đăng nhập để thực hiện tính năng này");
      return false;
    });
    $(".js-maintain").click(function (event) {
      event.preventDefault();
      toastr__WEBPACK_IMPORTED_MODULE_2___default.a.warning("Tính năng này đang phát triển. Mời bạn quay lại sau");
      return false;
    });
  },
  ...
  fixTopMenu: function fixTopMenu() {
    $(document).on('scroll', function () {
      var $header = $(".commonTop");
...
/* harmony default export */ __webpack_exports__["default"] = (RunCommon);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")))
...
var Comments = {
  ...
  saveComments: function saveComments() {
    $("body").on("click", ".js-save-comment", function (event) {
      event.preventDefault();
      var $this = $(this);
      var $domForm = $this.closest('form');

      if (typeof ROUTE_COMMENT !== "undefined") {
        var comment = $this.parents('form').find("textarea").val();

        if (!comment.length) {
          toastr__WEBPACK_IMPORTED_MODULE_0___default.a.warning('Nội dung comments không được để trống!');
          return false;
        }
  ...
  replyComment: function replyComment() {
    $("body").on("click", ".js-reply-comment", function (event) {
      ...
      var $listReply = $item.find(".comments-reply");
        ...
        $.ajax({
          ...
          if (results.code == 200) {
            ...
            if ($listReply.length) {
              ...
              var newListComment = "<div class=\"comments-reply\">" + results.html + "</div>";
  ...
  showFormReply: function showFormReply() {
    var _this = this;
    ...
    $("body").on("click", ".js-show-form-reply", function (event) {
      ...
      var html = _this.renderFormReply(productID, commentID, name);

      var $item = $this.parentsUntil('.item');
  ...
  paginationCommentAjax: function paginationCommentAjax() {
    var _this = this;

    $("body").on("click", ".pagination a", function (e) {
      e.preventDefault();
      var URL = $(this).attr('href'); // $("body .js-number-rating").removeClass('active');
  ...
  getListComments: function getListComments(URL) {
    $.ajax({
      type: "GET",
      url: URL,
  ...
  renderFormReply: function renderFormReply(productID, commentID, name) {
    return "<div class=\"form-comment\">\n                    <form action=\"\" method=\"POST\">\n                    <input type=\"hidden\" name=\"productId\" value=\"".concat(productID, "\">\n                    <input type=\"hidden\" name=\"commentId\" value=\"").concat(commentID, "\">\n                        <div class=\"form-group\">\n                            <textarea name=\"comment\" class=\"form-control\" id=\"\" cols=\"30\" rows=\"5\">@").concat(name, ": </textarea>\n                        </div>\n                        <div class=\"footer\">\n                            <p>\n                                <a href=\"\"><i class=\"la la-camera\"></i> G\u1EEDi \u1EA3nh</a>\n                                <a href=\"\">Quy \u0111\u1ECBnh \u0111\u0103ng b\xECnh lu\u1EADn</a>\n                            </p>\n                            <button class=\"js-reply-comment\" data-reply=\"\">G\u1EEDi b\xECnh lu\u1EADn</button>\n                        </div>\n                    </form>\n                </div>");
  }
};
...
/***/ "./resources/js/components/open_sidebar.js":
/*!*************************************************!*\
  !*** ./resources/js/components/open_sidebar.js ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./resources/js/library/lazyload.min.js":
/*!**********************************************!*\
  !*** ./resources/js/library/lazyload.min.js ***!
  \**********************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var slider_pro__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! slider-pro */ "./node_modules/slider-pro/dist/js/jquery.sliderPro.js");
/* harmony import */ var slider_pro__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(slider_pro__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _common_run_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../common/run_common */ "./resources/js/common/run_common.js");
/* harmony import */ var _components_comments_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/comments.js */ "./resources/js/components/comments.js");
/* harmony import */ var _common_lazyload_file__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../common/lazyload_file */ "./resources/js/common/lazyload_file.js");
...
/* harmony import */ var jquery_modal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! jquery-modal */ "./node_modules/jquery-modal/jquery.modal.js");
...
var ProductDetail = {
  ...
  showFormReview: function showFormReview() {
    // Show form review
    $(".js-review").click(function (event) {
      ...
      if ($this.hasClass('js-check-login')) {
        toastr__WEBPACK_IMPORTED_MODULE_5___default.a.warning("Đăng nhập để thực hiện chức năng này");
        return false;
      }
  ...
  processReview: function processReview() {
      ...
      $.ajax({
        ...
        if (results.html) {
          ...
          if (results.html !== null) {
            toastr__WEBPACK_IMPORTED_MODULE_5___default.a.success(results.messages);
        } else {
            toastr__WEBPACK_IMPORTED_MODULE_5___default.a.warning(results.messages);
        }
      });
    });
  },
  showPopupCaptcha: function showPopupCaptcha() {
    $("#popup-captcha").modal({
      escapeClose: false,
      clickClose: false,
      showClose: false
  ...
  submitCaptcha: function submitCaptcha() {
    $('.js-submit-captcha').on('click', function (e) {
      ...
      if (!recaptcha) {
        toastr__WEBPACK_IMPORTED_MODULE_5___default.a.warning('Bạn chưa xác nhận "Tôi không phải người máy" kìa!');
        return false;
      }
      ...
      $.ajax({
        ...
        toastr__WEBPACK_IMPORTED_MODULE_5___default.a.success(results.message);
        setTimeout(function () {
          window.location.reload();
        }, 2000);
      });
  ...
  loadCssLazy: function loadCssLazy() {
    if (typeof CSS != 'undefined') {
      Object(_common_lazyload_file__WEBPACK_IMPORTED_MODULE_4__["loadCss"])(CSS);
    }
  },
  ...
  runSlider: function runSlider() {
    ...
    var itemProductFive = DEVICE === 'mobile' ? 2 : 4;
  ...
  addProductRecently: function addProductRecently() {
...
$(function () {
  ProductDetail.init();
  _common_run_common__WEBPACK_IMPORTED_MODULE_2__["default"].init();
  _components_comments_js__WEBPACK_IMPORTED_MODULE_3__["default"].init();
});
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")))
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\website_ban_giay_dep\resources\js\pages\product_detail.js */"./resources/js/pages/product_detail.js");
